...
export const portfolioConfig: PortfolioConfig = {
  siteMetadata: {
    title: 'Sathish S',
    description: 'Portfolio website by Sathish',
    author: 'Sathish S',
  },
  ...
  sections: {
    ...
    about: {
      ...
      subtitle: 'Me',
      bio: [
        "Hi, I'm a Software Engineering enthusiast living in Chennai. I enjoy turning creative ideas into working solutions in my spare time.",
      ...
      details: [
        ...
        { label: 'Experience', value: 'Fresher (hands on Exprience in building projects)' },
      ],
      qualities: [
        {
          icon: 'Rocket',
  ...
  footer: {
    copyright: `© ${new Date().getFullYear()} Sathish. All rights reserved.`,
